...
exports.testArgs = function (test) {
    test.ok(test.expect instanceof Function, 'tests.expect');
    test.ok(test.done instanceof Function, 'tests.done');
    test.ok(test.ok instanceof Function, 'tests.ok');
    test.ok(test.same instanceof Function, 'tests.same');
    test.ok(test.equals instanceof Function, 'tests.equals');
    test.done();
};
