...
// most basic tests that should run, the tests_called object is tested
...
// generates tests functions for nodeunit assertions
...
exports.testIfError = makeTest('ifError', [false], [new Error('tests')]);
