...
exports.catchSetUpError = function (test) {
    test.expect(2);
    var test_error = new Error('tests error');
    var s = {
        setUp: function (callback) {
            throw test_error;
        },
        test: function (t) {
            test.ok(false, 'tests function should not be called');
            t.done();
        }
    };
...
exports.testErrorAndtearDownError = function (test) {
    test.expect(3);
    var error1 = new Error('tests error one');
    var error2 = new Error('tests error two');
    var s = {
        tearDown: function (callback) {
            callback(error2);
        },
