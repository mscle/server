...
function ParserTestSuite(callback){
	var inps = [
		...
		['', '1 Empty program'],
		['// tests', '2 Empty program'],
		['//tests\n', '3 Empty program'],
		['\n// tests', '4 Empty program'],
		['\n// tests\n', '5 Empty program'],
		['/* */', '6 Empty program'],
		['/*\ns,fd\n*/', '7 Empty program'],
		['/*\ns,fd\n*/\n', '8 Empty program'],
		...
		['\n\t// Used for trimming whitespace\n\ttrimLeft = /^\\s+/;\n\ttrimRight = /\\s+$/;\t\n','turned out this didnt crash (the tests below did), but whatever.'],
		...
		['(/\'/g, \'\\\\\\\'\') + "\'";', 'the sequence of escaped characters confused the tokenizer'],
                ['if (true) /=a/.tests("a");', 'regexp starting with "=" in not obvious context (not implied by preceding token)']
	];
