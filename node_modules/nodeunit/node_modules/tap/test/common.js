exports.taps = ["Tests for the foo module"
               ,{ok:true, name:"tests that the foo is fooish"
                ,file:"foo.js", line:8, name:"fooish tests"
                ,stack:new Error("fooish").stack}
               ,{ok:false, name:"a tests that the bar is barish"
                ,file:"bar.js", line:25
                ,expected:"bar\nbar\nbaz", actual:"rab\nrib\nzib"
                ,hash:{more:"\nstuff\nhere\n",regexp:/asdf/}}
               ,"Quux module tests"
