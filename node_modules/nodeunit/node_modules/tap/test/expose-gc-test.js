...
tap.test("gc tests when the gc isn't there", function (t) {
  console.error("gc tests")
  t.plan(1)
...
tap.test("gc tests when the gc should be there", function (t) {
  console.error("gc tests")
  t.plan(2)
  console.error("t.plan="+t._plan)

  t.test("tests for gc using --gc", function (t) {
    console.error("gc tests using --gc")
    t.plan(1)
    console.error("t.plan="+t._plan)
  ...
  t.test("tests for gc using --expose-gc", function (t) {
    console.error("gc tests using --expose-gc")
    t.plan(1)
    console.error("t.plan="+t._plan)
