var tap  =  require("../")
  ...
  , nestedTests = 
      ...
      , "tests('parent tests description', function (t) {"
      , " t.plan(2)"
      , " t.ok(true, 'tests in parent')"
      , " t.tests('child tests description', function (t) {"
      , "    t.plan(1)"
      , "    t.ok(true, 'tests in child')  "
      , " })"
      , "})"
      ].join("\n")
...
tap.test("nested tests, parent and child pass", function (t) {
   ...
   * '# parent tests description'
   *   'ok 1 tests in parent'
   * '# child tests description'
   *   'ok 2 tests in child'
   */
  ...
  cp.exec("node " + nestedTestsFile, function (err, stdo, stde) {
    var lines = stdo.split("\n")
      , parentDes =  lines.indexOf("# parent tests description")
      , parentRes =  lines.indexOf("ok 1 tests in parent")
      , childDes  =  lines.indexOf("# child tests description")
      , childRes  =  lines.indexOf("ok 2 tests in child")
